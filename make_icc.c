...
void make_std_negative_profile() {
  ...
  cmsHPROFILE in_profile = cmsOpenProfileFromFile("build_prof.icc", "r");
...
// From c1 images and computed by weka.
  ...
  */
  ...
  //cmsPipelineInsertStage(neg_pipeline, cmsAT_END, cmsStageAllocCLutFloatGranular(NULL, clut_data->Params->nSamples, 3, 3, tablef));
