...
sony_a7rm4_portra160_0_r190808: data/portra160-0-r190808_train.txt make_icc
	python3 build_prof.py --src=$< --film_name="Sony A7RM4 Portra160 R190808"  $(sony_a7rm4_triband_crosstalk_coefs) --debug --install_dir="$(INSTALL_DIR)"

.PHONY: sony_a7rm4_portra160-1_r190808
sony_a7rm4_portra160-1_r190808: data/portra160-1-r190808_train.txt make_icc
	python3 build_prof.py --src=$< --film_name="Sony A7RM4 Portra160-1 R190808"  $(sony_a7rm4_triband_crosstalk_coefs) --debug --install_dir="$(INSTALL_DIR)"
...
sony_a7rm4_portra160+2_r190808: data/portra160+2-r190808_train.txt make_icc
	python3 build_prof.py --src=$< --film_name="Sony A7RM4 Portra160+2 R190808"  $(sony_a7rm4_triband_crosstalk_coefs) --debug --install_dir="$(INSTALL_DIR)"
...
sony_a7rm4_ektar100_0_r190808: data/ektar100-0-r190808_train.txt make_icc
	python3 build_prof.py --src=$< --film_name="Sony A7RM4 Ektar100 R190808"  $(sony_a7rm4_triband_crosstalk_coefs) --debug --install_dir="$(INSTALL_DIR)"

.PHONY: sony_a7rm4_ektar100-1_r190808
sony_a7rm4_ektar100-1_r190808: data/ektar100-1-r190808_train.txt make_icc
	python3 build_prof.py --src=$< --film_name="Sony A7RM4 Ektar100-1 R190808"  $(sony_a7rm4_triband_crosstalk_coefs) --debug --install_dir="$(INSTALL_DIR)"
...
sony_a7rm4_ektar100+2_r190808: data/ektar100+2-r190808_train.txt make_icc
	python3 build_prof.py --src=$< --film_name="Sony A7RM4 Ektar100+2 R190808"  $(sony_a7rm4_triband_crosstalk_coefs) --debug --install_dir="$(INSTALL_DIR)"
