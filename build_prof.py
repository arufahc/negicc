...
def run_colprof_clut(ti3_name):
    ...
    # TODO: Return debug information from |out|.
    out = subprocess.check_output(['colprof', '-v',
...
def run_make_icc(
    ...
    write_build_prof_header(
        ...
        g_curve,
        b_curve)
    subprocess.check_output(['make', 'make_icc'])
    return subprocess.check_output(['bin_out/make_icc', film_name, clut_icc, mat_icc])
